...
{
    static int mostSuccessors(Graph g){
        int max = 0; int vertex = 0;
        for(int i = 0; i < g.size(); i++){int successors = g.getSuccessors(i).size(); if(successors > max){max = successors; vertex = i;}}
        return vertex;
    }
